 ...
 */
@WebServlet("/MyServletIdentification")
public class MyServletIdentification extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyServletIdentification() {
        super();
	...
	dispatcher = request.getRequestDispatcher("/resultat.jsp");
