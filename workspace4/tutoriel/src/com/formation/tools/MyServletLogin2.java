 ...
 */
@WebServlet("/MyServletLogin2")
public class MyServletLogin2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyServletLogin2() {
        super();
	...
	IdentificationBean personne = new IdentificationBean();
	...
	//dispatcher
	RequestDispatcher disp= request.getRequestDispatcher("/identification2.jsp");
